...
export default function ProductOptionTwo() {
  ...
  return (
    <main className="bg-paper text-ink">
      ...
      ===================================================== */}
      <section className="bg-paper px-6 pb-8 pt-8 md:px-10 lg:px-14 lg:pb-12">
        <div className="mx-auto max-w-[1600px]">
          {/* Breadcrumb / product meta */}
          <div className="flex items-center justify-between border-b border-line pb-7">
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.12em] text-ink-faint">
              <Link href="/ev-chargers">EV Charging</Link>
              <span>/</span>
              <span>AC Chargers</span>
              <span>/</span>
              <span className="text-ink">11kW Home Charger</span>
            </div>
            <span className="hidden font-mono text-[9px] uppercase tracking-[0.12em] text-ink-faint sm:block">
              ML / AC11
            </span>
          </div>

          {/* Main showroom */}
          <div className="relative min-h-[620px] overflow-hidden bg-image-well sm:min-h-[720px] lg:min-h-[820px]">
            {/* PRODUCT IMAGE */}
            ...
            <div className="absolute right-6 top-6 z-20 bg-inverse/85 px-5 py-4 text-right backdrop-blur-md md:right-9 md:top-9 lg:right-12 lg:top-11">
            ...
            {/* GALLERY NAV */}
            <div className="absolute bottom-0 left-0 right-0 z-30 flex h-[76px] bg-paper/94 backdrop-blur-md">
                ...
                >
                  <span
                    className={`font-mono text-[8px] ${
                      activeImage === index ? "text-accent" : "text-ink-faint/60"
                    }`}
                  >
                    0{index + 1}
                  </span>
          ...
          <div className="mt-3 flex flex-col bg-white sm:flex-row sm:items-stretch">
            <div className="flex flex-1 items-center px-6 py-5 lg:px-8">
              ...
              <button className="ml-auto hidden text-[10px] font-semibold uppercase tracking-[0.1em] text-brand lg:block">
                Check my EV →
              </button>
            </div>

            <div className="flex min-w-[190px] items-center border-t border-line px-6 py-5 sm:border-l sm:border-t-0">
              <div>
            ...
            <div className="flex min-w-[150px] items-center justify-between border-t border-line px-5 sm:border-l sm:border-t-0">
              <button
                type="button"
                onClick={() => setQuantity((value) => Math.max(1, value - 1))}
                className="text-[19px] text-ink-soft transition hover:text-black"
              >
                −
              </button>
            ...
            <button
              type="button"
              className="group flex min-h-[72px] min-w-[270px] items-center justify-between bg-brand px-7 text-brand-foreground transition-colors hover:brightness-110"
            >
          ...
          {/* MOBILE SPECS */}
          <div className="grid grid-cols-2 border-b border-line md:hidden">
      ...
      <section className="mx-auto max-w-[1260px] px-6 py-24 md:px-10 lg:py-32">
        ...
        <div className="mx-auto mt-16 max-w-[900px]">
          ...
          <div className="flex flex-col gap-5 border-b border-line py-8 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[10px] uppercase tracking-[0.12em] text-ink-faint">
                Your vehicle
              </p>
            ...
            <button className="flex items-center gap-3 text-[10px] font-semibold uppercase tracking-[0.11em] text-brand">
              <span className="h-[6px] w-[6px] bg-accent" />
              Compatible
            </button>
          </div>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <div className="flex h-[66px] min-w-[150px] items-center justify-between border border-line-strong px-5">
              <button
                onClick={() => setQuantity((value) => Math.max(1, value - 1))}
                className="text-[20px]"
              >
            ...
            <button
              type="button"
              className="group flex h-[66px] flex-1 items-center justify-between bg-accent px-7 text-accent-foreground"
            >
              <span className="text-[11px] font-semibold uppercase tracking-[0.11em]">
                Add to Cart
              </span>
              <span className="text-[20px] transition-transform group-hover:translate-x-2">
                →
              </span>
            </button>
          </div>
      ...
      <section className="bg-white px-6 py-24 text-center md:px-10 lg:py-36">
        ...
        >
          <p className="text-[11px] uppercase tracking-[0.15em] text-brand">
            Why 11kW?
          </p>
          ...
          <p className="mx-auto mt-8 max-w-[570px] text-[16px] leading-[1.7] text-ink-soft">
      ...
      {/* =====================================================
          COMPATIBILITY
      ===================================================== */}
      <section className="bg-surface px-6 py-24 md:px-10 lg:py-32">
        <div className="mx-auto max-w-[1100px]">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-[560px] text-[15px] leading-[1.65] text-ink-soft">
              ...
              {compatibilityMode === "vehicle" ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-10 h-[62px] w-full bg-inverse text-[11px] font-semibold uppercase tracking-[0.11em] text-white"
                  >
                    Check compatibility
                  </button>
                </motion.div>
                ...
                >
                  <textarea
                    ...
                    className="min-h-[140px] w-full resize-none border-b border-line-strong bg-transparent py-5 text-[28px] font-medium tracking-[-0.035em] outline-none placeholder:text-ink-faint/50"
                  />
                  <button
                    onClick={() => setCompatibilityChecked(true)}
                    className="mt-8 h-[62px] w-full bg-inverse text-[11px] font-semibold uppercase tracking-[0.11em] text-white"
                  >
                    Ask Multiline
                  </button>
                </motion.div>
            ...
            <AnimatePresence>
              {compatibilityChecked && (
                ...
                >
                  ...
                  <p className="mt-4 max-w-[650px] text-[15px] leading-[1.65] text-ink-soft">
      ...
      {/* =====================================================
          CHARGING ESTIMATOR
      ===================================================== */}
      <section className="bg-inverse px-6 py-24 text-inverse-foreground md:px-10 lg:py-32">
        <div className="mx-auto max-w-[1100px]">
          <div className="text-center">
          ...
          <div className="mx-auto mt-16 max-w-[750px]">
            <div className="text-center">
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                className="text-[56px] font-medium leading-none tracking-[-0.06em] sm:text-[72px]"
              >
                {chargingTimeLabel}
              </motion.p>
              <p className="mt-4 text-[12px] text-inverse-foreground/40">
        ...
        <div className="mx-auto max-w-[1450px]">
          <div className="grid gap-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-7 max-w-[430px] text-[15px] leading-[1.7] text-ink-soft">
              ...
              <button className="mt-10 flex h-[60px] w-full max-w-[420px] items-center justify-between bg-brand px-6 text-white">
      ...
      ===================================================== */}
      <section className="bg-paper px-6 py-24 md:px-10 lg:py-32">
      ...
      {/* =====================================================
          SOLAR
      ===================================================== */}
      <section className="bg-image-well px-6 py-24 md:px-10 lg:py-32">
        <div className="mx-auto max-w-[1250px] text-center">
          ...
          <p className="mx-auto mt-8 max-w-[580px] text-[16px] leading-[1.7] text-ink-soft">
          ...
          <button className="mt-10 bg-brand px-8 py-5 text-[10px] font-semibold uppercase tracking-[0.12em] text-white">
      ...
      {/* =====================================================
          FINAL PURCHASE
      ===================================================== */}
      <section className="bg-brand px-6 py-20 text-white md:px-10 lg:py-24">
        <div className="mx-auto flex max-w-[1250px] flex-col gap-12 lg:flex-row lg:items-end lg:justify-between">
          ...
          <button
            type="button"
            className="flex h-[72px] min-w-[320px] items-center justify-between bg-accent px-7 text-accent-foreground"
          >
            <span className="text-[11px] font-semibold uppercase tracking-[0.11em]">
              Add to Cart
            </span>
...
function ConfigRow({ label, title, meta, right }: { label: string; title: string; meta: string; right: string }) {
  return (
    <div className="flex flex-col gap-5 border-b border-line py-8 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <p className="text-[10px] uppercase tracking-[0.12em] text-ink-faint">{label}</p>
        <p className="mt-2 text-[20px] font-medium">{title}</p>
        <p className="mt-1 text-[12px] text-ink-faint">{meta}</p>
      </div>
...
function Choice({ active, title, description, onClick }: { active: boolean; title: string; description: string; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className={`p-5 text-left transition ${active ? "bg-brand text-white" : "border border-line bg-transparent"}`}
    >
      <div className="flex items-center justify-between">
        <span className="text-[14px] font-medium">{title}</span>
        <span className={`h-[7px] w-[7px] ${active ? "bg-accent" : "border border-line-strong"}`} />
      </div>
      <p className={`mt-3 text-[12px] leading-[1.5] ${active ? "text-white/50" : "text-ink-faint"}`}>
        {description}
      </p>
    </button>
  );
...
function Metric({ value, label }: { value: string; label: string }) {
  return (
    <div className="min-w-[150px] text-center">
      ...
      <p className="mt-2 text-[10px] uppercase tracking-[0.1em] text-ink-faint">{label}</p>
    </div>
  );
}
...
function ModeButton({ active, onClick, children }: { active: boolean; onClick: () => void; children: React.ReactNode }) {
  return (
    <button
      onClick={onClick}
      className={`pb-3 text-[10px] uppercase tracking-[0.11em] ${active ? "border-b-2 border-brand font-semibold text-brand" : "text-ink-faint"}`}
    >
      {children}
    </button>
  );
...
function VehicleField({ label, value }: { label: string; value: string }) {
  return (
    <button className="text-left">
      ...
      <div className="mt-3 flex items-center justify-between border-b border-line-strong pb-4">
...
function Result({ value, label }: { value: string; label: string }) {
  return (
    <div>
      ...
      <p className="mt-1 text-[9px] uppercase tracking-[0.09em] text-ink-faint">{label}</p>
    </div>
  );
}
...
function SimplePoint({ number, text }: { number: string; text: string }) {
  return (
    <div className="flex items-center gap-5 border-b border-line pb-4">
      <span className="font-mono text-[8px] text-ink-faint">{number}</span>
...
function Spec({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between gap-8 border-b border-line py-6">
...
function ChargerCard({ power, description, action, active = false }: { power: string; description: string; action: string; active?: boolean }) {
  return (
    <div className={`flex min-h-[360px] flex-col justify-between p-8 ${active ? "bg-brand text-white" : "bg-surface"}`}>
      <div>
        <div className="flex items-center justify-between">
          <p className="text-[40px] font-medium tracking-[-0.055em]">{power}</p>
          {active && <span className="h-[7px] w-[7px] bg-accent" />}
        </div>
        <p className={`mt-5 max-w-[240px] text-[14px] leading-[1.6] ${active ? "text-white/50" : "text-ink-faint"}`}>
          {description}
        </p>
      </div>
      <button className={`flex items-center justify-between border-t pt-5 text-[10px] uppercase tracking-[0.1em] ${active ? "border-white/20 text-accent" : "border-line"}`}>
        {action}
        {!active && <span>→</span>}
      </button>
    </div>
...
function MobileHeroSpec({ value, label }: { value: string; label: string }) {
  return (
    <div className="border-r border-t border-line px-5 py-5 even:border-r-0">
      <p className="text-[9px] uppercase tracking-[0.1em] text-ink-faint">{label}</p>
